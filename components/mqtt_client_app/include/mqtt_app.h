...
// ROOM_ID and DEVICE_ID are loaded at compile time
...
#define MQTT_TOPIC_SENSOR_STATUS_CHECK "/room/" ROOM_ID "/device/" DEVICE_ID "/sensor/check"    // esp is subscriber to this topic
